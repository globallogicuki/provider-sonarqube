...
type PermissionsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/globallogicuki/provider-sonarqube/apis/permissiontemplate/v1alpha1.PermissionTemplate
	// +crossplane:generate:reference:refFieldName=TemplateIDRef
	// +crossplane:generate:reference:selectorFieldName=TemplateIDSelector
	TemplateID *string `json:"templateId,omitempty" tf:"template_id,omitempty"`

	// Reference to a PermissionTemplate in permissiontemplate to populate templateId.
	// +kubebuilder:validation:Optional
	TemplateIDRef *v1.Reference `json:"templateIdRef,omitempty" tf:"-"`

	// Selector for a PermissionTemplate in permissiontemplate to populate templateId.
	// +kubebuilder:validation:Optional
