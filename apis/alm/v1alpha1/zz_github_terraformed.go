...
func (tr *GitHub) GetObservation() (map[string]any, error) {
...
func (tr *GitHub) SetObservation(obs map[string]any) error {
...
func (tr *GitHub) GetParameters() (map[string]any, error) {
...
func (tr *GitHub) SetParameters(params map[string]any) error {
...
// GetInitParameters of this GitHub
func (tr *GitHub) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GitHub
func (tr *GitHub) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
